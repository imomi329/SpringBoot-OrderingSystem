package com.finsage.user.mapper;

import java.util.List;

import org.apache.ibatis.annotations.Param;

import com.finsage.user.bean.User;
...
//	@Select("select * from user where name = #{name} and email = #{email}")
	public List<User> select1(@Param("name")String name, @Param("email")String email);
...
//	@Select("swelect * from uder order by ${orderField} ${ascOrDesc}")
	public User select5(@Param("orderField")String orderField, @Param("ascOrDesc")String ascOrDesc);
